...
In conclusion, we can see that the trees generated by this BVH method are pretty good: in most scenes, the BVH building takes a significant portion of the runtime. I also didn't implement many constant optimizations to the actual ray tracing. For example, I use runtime polymorphism to support spheres and triangles. 
